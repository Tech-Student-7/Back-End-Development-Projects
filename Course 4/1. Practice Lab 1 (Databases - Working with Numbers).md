...
coder@fe9dae05798c:~/project$ mysql;
...
mysql> CREATE DATABASE DB_YASMINN;
Query OK, 1 row affected (0.02 sec)

mysql> USE DB_YASMINN;
Database changed
mysql> CREATE DATABASE yasmin_devices;
Query OK, 1 row affected (0.03 sec)

mysql> USE yasmin_devices;
Database changed
mysql> CREATE TABLE devices( deviceID int, deviceName varchar(50), price decimal);
Query OK, 0 rows affected (0.18 sec)

mysql> CREATE TABLE stock(deviceID int, quantity int, totalCost decimal);
